...
import { Avatar1, Avatar2, Avatar3, Avatar4, Avatar5 } from '../../data/images.jsx';
    ...
    >
      <Stack p={3.5} pb={1} spacing={1.5} alignItems="center">
        <Stack
          ...
          borderRadius={3}
        >
          <Icon icon="mdi:fire" color="error.main" fontSize="h2.fontSize" />
        </Stack>
      ...
      >
        <Stack alignItems="center" spacing={3.5}>
          ...
          p={'0px'}>
            <Icon icon="ic:sharp-timer" color="success.dark" fontSize="h4.fontSize" />
